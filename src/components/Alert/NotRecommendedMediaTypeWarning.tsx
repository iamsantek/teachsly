    ...
    <Alert status="error" flexDirection="column" gap={4}>
      <Flex flexDirection="row">
        ...
        <Text fontWeight={"bold"}>
          {translate("NOT_RECOMMENDED_MEDIA_TYPES_WORDING")}
        </Text>
      </Flex>
      <TableContainer>
        <Table
        ...
        >
          <Thead>
            <Tr>
              <Th wordBreak="break-word">
                {translate("NOT_RECOMMENDED_MEDIA_TYPES_TABLE_TITLE_1")}
              </Th>
          ...
          <Tbody>
            <Tr>
              <Td wordBreak="break-word">
                {translate("FILES_WITH_INFORMATION_TITLE")}
              </Td>
      ...
      <Text fontWeight="semibold">
        {translate("NOT_RECOMMENDED_MEDIA_TYPES_FINAL_WORDING")}
      </Text>
    </Alert>
  );
};
