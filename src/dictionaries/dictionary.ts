...
export enum LanguageES {
  ...
  RIGHT_ANSWERS = "Puntaje obtenido",
  ...
  RECORDING_DELETED_SUCCESS = "La grabación se eliminó correctamente.",
  RECORDING_DELETED_ERROR = "Hubo un error al eliminar la grabación. Por favor, intentar nuevamente.",
...
export enum LanguageEN {
  ...
  RECORDING_DELETED_SUCCESS = "The recording has been successfully deleted.",
  RECORDING_DELETED_ERROR = "An error has occurred when deleting the recording. Please try again.",
