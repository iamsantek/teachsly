import { Text, Accordion, AccordionItem, AccordionButton, Box, AccordionIcon, AccordionPanel, Badge, HStack } from '@chakra-ui/react'
  ...
  return (
        <Accordion allowMultiple>
            {questionPools.map((questionPool, questionPoolIndex) => {
              ...
              const { color: badgeColor, text: badgeText } = isPendingCorrectionInQuestionPool(questionPool)
              return (
                            ...
                            <AccordionButton>
                                <Box flex='1' textAlign='left'>
                                    <HStack>
                                        ...
                                        <Badge colorScheme={badgeColor}>{translate(badgeText)}</Badge>
                                    </HStack>
