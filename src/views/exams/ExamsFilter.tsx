...
export const ExamFilter = ({
  ...
  const groupList = renderCourseList({ courses: groups });
  ...
  return (
    <Flex alignItems="center" gap={5}>
      ...
      <Select
        ...
        onChange={(e) => onChangeStatusFilter(e.target.value as IExamFilter)}
      >
        ...
        {!hasEditPermission && (
          <>
            ...
            <option value={IExamFilter.CORRECTED}>
              {translate("CORRECTED")}
            </option>
            <option value={IExamFilter.PENDING_CORRECTION}>
              {translate("NOT_CORRECTED")}
            </option>
          </>
        )}
      </Select>
